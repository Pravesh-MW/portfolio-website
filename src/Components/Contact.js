...
const Contact = () => {
    return (
        <div id='contact' className="flex flex-col min-h-screen space-y-4 justify-start items-center bg-gradient-to-r from-slate-300 to-slate-500 m-4 p-2">
            <div className='flex flex-col justify-center items-center h-1/3 space-y-4 mt-16'>
                ...
                <p className='text-ls text-gray-800 px-2'>Build a strong connection to change the world</p>
            </div>

    ...
    return (
        <div className='flex justify-center items-center h-screen bg-gradient-to-r from-slate-300 to-slate-500'>
            <div className='flex items-start justify-center flex-col space-y-2'>
                <p className='text-xl font-bold text-gray-400'>Hi there i</p>
                ...
                <a href='#' className='px-4 py-2 bg-blue-500 text-gray-800 hover:bg-blue-600 hover:text-gray-900 rounded-sm'>Know me</a>
            </div>
        </div>
    );
}
